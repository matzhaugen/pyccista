...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_ccista(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "ccista", 9, 9, swig_obj)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
  ...
  ecode18 = SWIG_AsVal_double(swig_obj[6], &val18);
  ...
  ecode19 = SWIG_AsVal_int(swig_obj[7], &val19);
  ...
  ecode20 = SWIG_AsVal_int(swig_obj[8], &val20);
...
static PyMethodDef SwigMethods[] = {
	 { "ccista", _wrap_ccista, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
